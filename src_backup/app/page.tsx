...
export default function LandingPage() {
  ...
  return (
    <main className="relative bg-black text-white overflow-hidden">
      {/* Hero Odyssey with WebGL Lightning */}
      <HeroOdyssey />
      ...
      <section className="relative py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-7xl font-light tracking-tight">Featured Expeditions</h2>
          </motion.div>
      ...
      <footer className="border-t border-white/5 py-12 text-center">
        ...
        <p className="text-xs text-white/20 mt-1">© 2026 — All expeditions begin with a single frame.</p>
      </footer>
    </main>
  );
}
