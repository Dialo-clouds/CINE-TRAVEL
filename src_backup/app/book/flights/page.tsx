      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center justify-between mb-8">
          ...
          <select
            ...
            className="h-10 rounded-xl bg-white/5 border border-white/10 px-3 text-sm text-white focus:outline-none"
          >
            ...
            >
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t border-white/5">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-24 h-px bg-white/10 my-1 relative">
        ...
        <div className="mt-8 flex justify-between">
          <button onClick={() => router.push("/book")} className="text-sm text-gray-500 hover:text-white transition-colors">
            Back to Search
          </button>
          <button
            onClick={handleContinue}
            disabled={!selectedFlight}
            className="px-8 py-3 rounded-xl bg-white text-black font-medium hover:bg-gray-200 transition-colors disabled:opacity-30 disabled:cursor-not-allowed flex items-center gap-2"
          >
