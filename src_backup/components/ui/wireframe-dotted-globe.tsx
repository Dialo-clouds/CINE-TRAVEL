...
export default function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center rounded-2xl p-8 bg-black">
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <canvas ref={canvasRef} className="w-full h-auto rounded-2xl" style={{ maxWidth: "100%", height: "auto" }} />
      <div className="absolute bottom-4 left-4 text-xs text-gray-500 px-2 py-1 rounded-md bg-black/80">
