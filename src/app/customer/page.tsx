...
import { Plane, Ticket, User, ArrowRight, Plus, Search, Package, Bell, Shield, Calendar, Map } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto px-10 py-12">
      ...
      <div className="grid grid-cols-4 gap-3 mb-8">
        <Link href="/book" className="group p-4 rounded-xl border border-white/[0.04] hover:border-white/[0.08] hover:bg-white/[0.01] transition-all">
          <Plane className="w-6 h-6 text-white/20 group-hover:text-white/50 transition-colors mb-2" />
          <h3 className="text-xs font-medium">Book Flight</h3>
        </Link>
        <Link href="/book/multi" className="group p-4 rounded-xl border border-white/[0.04] hover:border-white/[0.08] hover:bg-white/[0.01] transition-all">
          <Map className="w-6 h-6 text-white/20 group-hover:text-white/50 transition-colors mb-2" />
          <h3 className="text-xs font-medium">Multi-City</h3>
        </Link>
        <Link href="/book/calendar" className="group p-4 rounded-xl border border-white/[0.04] hover:border-white/[0.08] hover:bg-white/[0.01] transition-all">
          <Calendar className="w-6 h-6 text-white/20 group-hover:text-white/50 transition-colors mb-2" />
          <h3 className="text-xs font-medium">Price Calendar</h3>
        </Link>
        <Link href="/book/insurance" className="group p-4 rounded-xl border border-white/[0.04] hover:border-white/[0.08] hover:bg-white/[0.01] transition-all">
          <Shield className="w-6 h-6 text-white/20 group-hover:text-white/50 transition-colors mb-2" />
          <h3 className="text-xs font-medium">Insurance</h3>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-4 gap-3 mb-12">
        <Link href="/customer/track" className="group p-4 rounded-xl border border-white/[0.04] hover:border-white/[0.08] hover:bg-white/[0.01] transition-all">
          <Search className="w-6 h-6 text-white/20 group-hover:text-white/50 transition-colors mb-2" />
          <h3 className="text-xs font-medium">Flight Status</h3>
        </Link>
        <Link href="/customer/baggage" className="group p-4 rounded-xl border border-white/[0.04] hover:border-white/[0.08] hover:bg-white/[0.01] transition-all">
          <Package className="w-6 h-6 text-white/20 group-hover:text-white/50 transition-colors mb-2" />
          <h3 className="text-xs font-medium">Baggage</h3>
        </Link>
        <Link href="/customer/notifications" className="group p-4 rounded-xl border border-white/[0.04] hover:border-white/[0.08] hover:bg-white/[0.01] transition-all">
          <Bell className="w-6 h-6 text-white/20 group-hover:text-white/50 transition-colors mb-2" />
        ...
        <Link href="/customer/profile" className="group p-4 rounded-xl border border-white/[0.04] hover:border-white/[0.08] hover:bg-white/[0.01] transition-all">
          <User className="w-6 h-6 text-white/20 group-hover:text-white/50 transition-colors mb-2" />
          <h3 className="text-xs font-medium">Profile</h3>
        </Link>
      </div>
          ...
          {bookings.map((b) => (
            <div key={b.id} className="p-4 rounded-xl border border-white/[0.04] hover:border-white/[0.08] transition-all flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-mono text-xs text-gray-500">{b.booking_reference}</p>
                  <p className="text-xs text-gray-600 mt-0.5">{b.seat_class} · {b.total_passengers} passenger(s)</p>
                </div>
              </div>
